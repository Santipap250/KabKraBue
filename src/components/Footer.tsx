      ...
      <div className="container-content py-16 sm:py-20">
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            ...
            <p className="mt-1 font-mono text-xs uppercase tracking-[0.2em] text-rice/50">
              {siteConfig.nameThai}
            </p>
            <p className="mt-4 max-w-sm leading-relaxed text-rice/70">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {siteConfig.nav.map((item) => (
                <li key={item.href}>
                  <a href={item.href} className="text-sm text-rice/70 hover:text-rice">
                    {item.label}
                  </a>
                </li>
              ))}
        ...
        <div className="mt-16 flex flex-col gap-3 border-t border-rice/10 pt-6 font-mono text-[11px] uppercase tracking-[0.15em] text-rice/40 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6">
            <a href="#" className="hover:text-rice/70">
              Privacy
            </a>
            <a href={siteConfig.github} target="_blank" rel="noopener noreferrer" className="hover:text-rice/70">
              GitHub
            </a>
          </div>
        </div>
