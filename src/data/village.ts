...
และเมื่อฤดูแล้งมาเยือน ผืนดินที่เคยเขียวก็แปรเปลี่ยนไปอีกแบบ เผยให้เห็นเส้นสายของคันนาและแนวต้นไม้ริมทางที่ตัดกับท้องฟ้าใส ธรรมชาติของกาบกระบือจึงไม่เคยซ้ำเดิมในแต่ละฤดู แต่ยังคงความงามในแบบของตัวเองเสมอ`,
  ...
  titleThai: "ช่วงเวลาที่ผู้คนกลับมาอยู่ร่วมกัน",
  body: `วัฒนธรรมของหมู่บ้านไม่ได้อยู่ไกลจากชีวิตประจำวัน แต่ปรากฏอยู่ในช่วงเวลาที่ผู้คนกลับมาอยู่ร่วมกัน — ในรอยยิ้ม การแบ่งปัน การช่วยเหลือกัน และกิจกรรมที่ทำให้พื้นที่ธรรมดากลายเป็นความทรงจำร่วม

ภาพของผู้คนในวันหนึ่งอาจเป็นทั้งความสนุก ความเหน็ดเหนื่อย หรือการดูแลซึ่งกันและกัน แต่สิ่งที่อยู่เบื้องหลังเหมือนกันคือความรู้สึกว่า “เราอยู่ที่นี่ด้วยกัน” และบ้านไม่ได้หมายถึงเพียงสถานที่ แต่หมายถึงผู้คนที่ทำให้สถานที่นั้นมีชีวิต

ภาพชุดนี้จึงตั้งใจบันทึกบรรยากาศของช่วงเวลาที่ผู้คนกลับมาใกล้ชิดกัน ให้รายละเอียดเล็ก ๆ ของรอยยิ้ม สายน้ำ พื้นที่รอบบ้าน และกิจกรรมของชุมชน เป็นอีกหน้าหนึ่งของเรื่องราวกาบกระบือที่ค่อย ๆ เดินทางจากวันหนึ่งไปสู่อีกวัน`,
  imageAlt: "ภาพกิจกรรมร่วมกันของผู้คนในชุมชนกาบกระบือ",
  imageId: "culture-01.webp",
  gallery: [
    {
      imageId: "culture-02.webp",
      imageAlt: "ภาพบรรยากาศผู้คนร่วมกิจกรรมในพื้นที่ชุมชนกาบกระบือ",
    },
    {
